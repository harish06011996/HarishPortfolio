    ...
    <div style={styles.page}>
      ...
      <header style={styles.hero}>
        ...
        <div style={{ marginTop: 25 }}>
          ...
          <a href="https://www.linkedin.com/in/harish-kumar-sdet" target="_blank" rel="noreferrer" style={styles.secondaryBtn}>LinkedIn</a>
      ...
      <section id="contributions" style={styles.sectionAlt}>
        ...
        <div style={styles.expCard}>
          <p style={styles.intro}>
            Designed and developed "TC Gen" – an intelligent Test Case Generation tool that empowers non-technical stakeholders to automatically generate structured manual test cases from Playwright scripts and business documents (PPT & Excel). The tool interprets automation steps into readable manual test steps with expected results, significantly reducing test design effort and improving collaboration between QA and business teams.
          </p>
          <ul style={styles.list}>
        ...
        <div style={styles.contactWrapper}>
          ...
          <div style={styles.infoCard}>
            <div style={styles.contactItem}>
              ...
              <button onClick={copyEmail} style={styles.copyBtn}>{copied ? "Copied" : "Copy"}</button>
            </div>
            <a href="tel:+918791543176" style={styles.contactItem}>📱 +91 87915 43176</a>
          </div>
        </div>
      </section>
...
const getStyles = (darkMode) => ({
  ...
  navLink: { margin: "0 10px", textDecoration: "none", color: "#38bdf8", fontWeight: "bold" },
  themeBtn: { background: "transparent", border: "none", cursor: "pointer" },
  hero: { textAlign: "center", padding: "90px 20px" },
  h1: { fontSize: 48 },
  tagline: { color: "#38bdf8" },
  badge: { marginTop: 10, padding: "6px 14px", backgroundColor: "#16a34a", borderRadius: 20, display: "inline-block" },
  primaryBtnLarge: { padding: "12px 20px", background: "#0ea5e9", color: "white", borderRadius: 8, textDecoration: "none", marginRight: 10 },
  secondaryBtn: { padding: "12px 20px", border: "1px solid #38bdf8", borderRadius: 8, textDecoration: "none", marginRight: 10, color: "#38bdf8" },
  ...
  contactItem: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: 10, borderRadius: 8, backgroundColor: darkMode ? "#0f172a" : "#f1f5f9", marginBottom: 10, textDecoration: "none", color: darkMode ? "#f1f5f9" : "#0f172a" },
  copyBtn: { padding: "4px 8px", border: "none", borderRadius: 5, cursor: "pointer" },
